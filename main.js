...
var InformationService = /** @class */ (function () {
    function InformationService(_http) {
        ...
        this._technicalUrl = '/assets/json/technical.json';
    }
    ...
    InformationService.prototype.getTechnical = function () {
        return this._http.get(this._technicalUrl);
    };
