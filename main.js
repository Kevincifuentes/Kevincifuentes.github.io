...
var SkillsComponent = /** @class */ (function () {
    ...
    SkillsComponent.prototype.ngOnInit = function () {
        ...
        // this.informationService.getAwards().subscribe(response => {this.languages = response.json()});
        //this.informationService.getOthers().subscribe(response => {this.languages = response.json()});
    };
